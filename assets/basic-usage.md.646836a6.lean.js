import{_ as n,c as a,a as t,o as p}from"./app.9ca3f453.js";const d='{"title":"Basic usage","description":"","frontmatter":{},"headers":[{"level":3,"title":"store/index.ts","slug":"store-index-ts"},{"level":3,"title":"store/test.ts","slug":"store-test-ts"},{"level":3,"title":"store/user.ts","slug":"store-user-ts"},{"level":3,"title":"helper/pinia-auto-refs.ts","slug":"helper-pinia-auto-refs-ts"},{"level":3,"title":"useStore Demo","slug":"usestore-demo"}],"relativePath":"basic-usage.md"}',e={};function o(c,s,l,r,u,k){return p(),a("div",null,s[0]||(s[0]=[t(`<h1 id="basic-usage" tabindex="-1">Basic usage <a class="header-anchor" href="#basic-usage" aria-hidden="true">#</a></h1><p>You need to switch the store export mode to <code>export default</code>, because we can&#39;t get what you exported directly when we import automatically. Using <code>export default</code> makes it much easier.</p><h3 id="store-index-ts" tabindex="-1">store/index.ts <a class="header-anchor" href="#store-index-ts" aria-hidden="true">#</a></h3><div class="language-ts"><pre><code><span class="token keyword">const</span> store <span class="token operator">=</span> <span class="token function">createPinia</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
<span class="token keyword">import</span> <span class="token punctuation">{</span> AutoToRefs<span class="token punctuation">,</span> ToRef <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;vue&#39;</span>
...
<span class="token keyword">declare</span> <span class="token keyword">module</span> <span class="token string">&#39;vue&#39;</span> <span class="token punctuation">{</span>
  <span class="token keyword">export</span> <span class="token keyword">type</span> <span class="token class-name">AutoToRefs<span class="token operator">&lt;</span><span class="token constant">T</span><span class="token operator">&gt;</span></span> <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token generic-function"><span class="token function">useStore</span><span class="token generic class-name"><span class="token operator">&lt;</span><span class="token constant">T</span> <span class="token keyword">extends</span> <span class="token keyword">keyof</span> <span class="token keyword">typeof</span> storeExports<span class="token operator">&gt;</span></span></span><span class="token punctuation">(</span>storeName<span class="token operator">:</span> <span class="token constant">T</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> <span class="token punctuation">{</span> <span class="token operator">...</span>store<span class="token punctuation">,</span> <span class="token operator">...</span>storeRefs <span class="token punctuation">}</span> <span class="token keyword">as</span> <span class="token builtin">unknown</span> <span class="token keyword">as</span> AutoToRefs<span class="token operator">&lt;</span>ReturnType<span class="token operator">&lt;</span><span class="token keyword">typeof</span> storeExports<span class="token punctuation">[</span><span class="token constant">T</span><span class="token punctuation">]</span><span class="token operator">&gt;&gt;</span>
<span class="token punctuation">}</span>
...
</code></pre></div>`,12)]))}var f=n(e,[["render",o]]);export{d as __pageData,f as default};
