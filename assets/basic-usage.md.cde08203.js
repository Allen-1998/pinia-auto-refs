import{_ as s,c as n,o as a,a as t}from"./app.f159318c.js";const g='{"title":"Basic usage","description":"","frontmatter":{},"headers":[{"level":3,"title":"store/index.ts","slug":"store-index-ts"},{"level":3,"title":"store/test.ts","slug":"store-test-ts"},{"level":3,"title":"store/user.ts","slug":"store-user-ts"},{"level":3,"title":"helper/pinia-auto-refs.ts","slug":"helper-pinia-auto-refs-ts"},{"level":3,"title":"useStore Demo","slug":"usestore-demo"}],"relativePath":"basic-usage.md"}',p={},o=t(`<h1 id="basic-usage" tabindex="-1">Basic usage <a class="header-anchor" href="#basic-usage" aria-hidden="true">#</a></h1><h3 id="store-index-ts" tabindex="-1">store/index.ts <a class="header-anchor" href="#store-index-ts" aria-hidden="true">#</a></h3><div class="language-ts"><pre><code><span class="token keyword">const</span> store <span class="token operator">=</span> <span class="token function">createPinia</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
